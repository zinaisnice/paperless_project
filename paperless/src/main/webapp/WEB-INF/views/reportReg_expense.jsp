						...
						<td style="height: 200px;"> 
							<table>
								<tr>
									...
									<th style="width: 100px;">영수증번호</th>
									<th style="width: 100px;">지출일</th>
								...
								<tr>
									...
									<td style="padding: 5px;"> <!-- 비용, 3자리 마다 , 찍히기 -->
										<input type="text" name="cost" class="cost money" size="8"> 원 
									</td>
